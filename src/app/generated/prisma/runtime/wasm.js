...
var _e = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
  ...
  cn = (t, e, r, n) => {
    if ((e && typeof e == "object") || typeof e == "function") for (let i of zo(e)) !Xo.call(t, i) && i !== r && St(t, i, { get: () => e[i], enumerable: !(n = Ho(e, i)) || n.enumerable });
    return t;
  };
var rt = (t, e, r) => ((r = t != null ? Ko(Yo(t)) : {}), cn(e || !t || !t.__esModule ? St(r, "default", { value: t, enumerable: !0 }) : r, t)),
    ...
    o = (a, f) =>
      function (g, T = 0) {
        let C = r[a].match(/set(\w+\d+)/)[1].toLowerCase(),
          k = rs[C];
        return B(T, "offset"), z(T, "offset"), $(T, "offset", this.length - 1), ts(g, "value", k[0], k[1]), new DataView(this.buffer)[r[a]](T, g, f), T + parseInt(r[a].match(/\d+/)[0]) / 8;
      },
    s = (a) => {
      a.forEach((f) => {
  ...
  u = ue(() => {
    ...
    y = class t extends Uint8Array {
      ...
      fill(e = 0, r = 0, n = this.length, i = "utf-8") {
        ...
        if (((i = typeof r == "string" ? r : typeof n == "string" ? n : i), (e = t.from(typeof e == "number" ? [e] : e ?? [], i)), mn(i, "encoding"), $(o, "offset", this.length), $(s, "end", this.length), e.length !== 0))
    ...
    (rs = {
      ...
      (ns = new TextEncoder()),
      (is = new TextDecoder()),
      (os = ["utf8", "utf-8", "hex", "base64", "ascii", "binary", "base64url", "ucs2", "ucs-2", "utf16le", "utf-16le", "latin1", "latin-1"]),
      (ss = 4294967295);
    es(y.prototype);
    (b = new Proxy(as, {
      construct(t, [e, r]) {
...
function hn(t, e) {
  ...
  if (((f = t.d), (g = e.d), (s = t.e), (i = e.e), (f = f.slice()), (o = s - i), o)) {
    for (o < 0 ? ((n = f), (o = -o), (a = g.length)) : ((n = g), (i = s), (a = f.length)), s = Math.ceil(C / N), a = s > a ? s + 1 : a + 1, o > a && ((o = a), (n.length = 1)), n.reverse(); o--; ) n.push(0);
    n.reverse();
  }
  for (a = f.length, o = g.length, a - o < 0 && ((o = a), (n = g), (g = f), (f = n)), r = 0; o; ) (r = ((f[--o] = f[o] + g[o] + r) / Q) | 0), (f[o] %= Q);
...
function nt(t, e) {
  ...
  } else return (f = xr(S, g + 2, I).times(o + "")), (A = nt(new S(n + "." + r.slice(1)), g - k).plus(f)), (S.precision = I), e == null ? ((U = !0), D(A, I)) : A;
...
function D(t, e, r) {
  ...
  if (
    (r !== void 0 &&
      ...
      (f = r < 4 ? (a || f) && (r == 0 || r == (t.s < 0 ? 3 : 2)) : a > 5 || (a == 5 && (r == 4 || f || (r == 6 && (n > 0 ? (i > 0 ? g / Ae(10, s - i) : 0) : C[T - 1]) % 10 & 1) || r == (t.s < 0 ? 8 : 7))))),
    e < 1 || !C[0])
  )
    return f ? ((o = V(t)), (C.length = 1), (e = e - o - 1), (C[0] = Ae(10, (N - (e % N)) % N)), (t.e = Fe(-e / N) || 0)) : ((C.length = 1), (C[0] = t.e = t.s = 0)), t;
  if ((n == 0 ? ((C.length = T), (o = 1), T--) : ((C.length = T + 1), (o = Ae(10, N - n)), (C[T] = i > 0 ? ((g / Ae(10, s - i)) % Ae(10, i) | 0) * o : 0)), f))
    for (;;)
      if (T == 0) {
        (C[0] += o) == Q && ((C[0] = 1), ++t.e);
        break;
...
function bn(t, e) {
  ...
  if (((f = t.d), (C = e.d), (n = e.e), (g = t.e), (f = f.slice()), (s = g - n), s)) {
    for (T = s < 0, T ? ((r = f), (s = -s), (a = C.length)) : ((r = C), (n = g), (a = f.length)), i = Math.max(Math.ceil(A / N), a) + 2, s > i && ((s = i), (r.length = 1)), r.reverse(), i = s; i--; ) r.push(0);
    r.reverse();
  } else {
...
var De,
  ...
  En = ue(() => {
    ...
    l();
    (De = 1e9),
      (ls = { precision: 20, rounding: 4, toExpNeg: -7, toExpPos: 21, LN10: "2.302585092994045684017991454684364207601101488628772976033327900967572609677352480235997205089598298341967784042286" }),
      (U = !0),
      (ne = "[DecimalError] "),
    ...
    R.squareRoot = R.sqrt = function () {
      ...
      for (
        t = V(a),
          ...
          i = Math.sqrt(+a),
          i == 0 || i == 1 / 0
            ? ((e = ce(a.d)), (e.length + t) % 2 == 0 && (e += "0"), (i = Math.sqrt(e)), (t = Fe((t + 1) / 2) - (t < 0 || t % 2)), i == 1 / 0 ? (e = "5e" + t) : ((e = i.toExponential()), (e = e.slice(0, e.indexOf("e") + 1) + t)), (n = new f(e)))
            : (n = new f(i.toString())),
          r = f.precision,
          i = s = r + 3;
        ;
    ...
    R.times = R.mul = function (t) {
      ...
      for (t.s *= T.s, r = T.e + t.e, f = k.length, g = A.length, f < g && ((o = k), (k = A), (A = o), (s = f), (f = g), (g = s)), o = [], s = f + g, n = s; n--; ) o.push(0);
      for (n = g; --n >= 0; ) {
    ...
    R.toDecimalPlaces = R.todp = function (t, e) {
      var r = this,
        n = r.constructor;
      return (r = new n(r)), t === void 0 ? r : (me(t, 0, De), e === void 0 ? (e = n.rounding) : me(e, 0, 8), D(r, t + V(r) + 1, e));
    };
    R.toExponential = function (t, e) {
      var r,
        n = this,
        i = n.constructor;
      return t === void 0 ? (r = ke(n, !0)) : (me(t, 0, De), e === void 0 ? (e = i.rounding) : me(e, 0, 8), (n = D(new i(n), t + 1, e)), (r = ke(n, !0, t + 1))), r;
    };
    R.toFixed = function (t, e) {
      var r,
        ...
        i = this,
        o = i.constructor;
      return t === void 0 ? ke(i) : (me(t, 0, De), e === void 0 ? (e = o.rounding) : me(e, 0, 8), (n = D(new o(i), t + V(i) + 1, e)), (r = ke(n.abs(), !1, t + V(n) + 1)), i.isneg() && !i.isZero() ? "-" + r : r);
    };
    ...
    R.toPower = R.pow = function (t) {
      ...
      if (((e = t.e), (r = t.d.length - 1), (s = e >= r), (o = a.s), s)) {
        if ((r = T < 0 ? -T : T) <= gn) {
          for (i = new f(Z), e = Math.ceil(n / N + 4), U = !1; r % 2 && ((i = i.times(a)), fn(i.d, e)), (r = Fe(r / 2)), r !== 0; ) (a = a.times(a)), fn(a.d, e);
    ...
    R.toPrecision = function (t, e) {
      var r,
        ...
        i = this,
        o = i.constructor;
      return t === void 0 ? ((r = V(i)), (n = ke(i, r <= o.toExpNeg || r >= o.toExpPos))) : (me(t, 1, De), e === void 0 ? (e = o.rounding) : me(e, 0, 8), (i = D(new o(i), t, e)), (r = V(i)), (n = ke(i, t <= r || r <= o.toExpNeg, t))), n;
    };
    R.toSignificantDigits = R.tosd = function (t, e) {
      var r = this,
        n = r.constructor;
      return t === void 0 ? ((t = n.precision), (e = n.rounding)) : (me(t, 1, De), e === void 0 ? (e = n.rounding) : me(e, 0, 8)), D(new n(r), t, e);
    };
    R.toString =
      R.valueOf =
      R.val =
    ...
    be = (function () {
      ...
      return function (n, i, o, s) {
        ...
        if ((q[g] > (le[g] || 0) && --f, o == null ? (K = o = At.precision) : s ? (K = o + (V(n) - V(i)) + 1) : (K = o), K < 0)) return new At(0);
        if (((K = (K / N + 2) | 0), (g = 0), se == 1)) for (T = 0, q = q[0], K++; (g < _ || T) && K--; g++) (Le = T * Q + (le[g] || 0)), (O[g] = (Le / q) | 0), (T = Le % q | 0);
        else {
          for (T = (Q / (q[0] + 1)) | 0, T > 1 && ((q = t(q, T)), (le = t(le, T)), (se = q.length), (_ = le.length)), H = se, S = le.slice(0, se), I = S.length; I < se; ) S[I++] = 0;
            ...
            (T = 0),
              ...
              a < 0
                ? ((oe = S[0]),
                  se != I && (oe = oe * Q + (S[1] || 0)),
                  (T = (oe / br) | 0),
                  T > 1 ? (T >= Q && (T = Q - 1), (C = t(q, T)), (k = C.length), (I = S.length), (a = e(C, S, k, I)), a == 1 && (T--, r(C, se < k ? Rt : q, k))) : (T == 0 && (a = T = 1), (C = q.slice())),
                  (k = C.length),
                  k < I && C.unshift(0),
                  r(S, C, I),
    ...
    return function (e, r) {
      ...
      for (var _ = H.length - 1; a < o - 3; )
        for (I = r.charCodeAt(s + (g = a)), oe = r.charCodeAt(s + (T = a + 1)), K = r.charCodeAt(s + (C = a + 2)), Le = r.charCodeAt(s + (k = a + 3)), A = a += 4, f = 0; f < _; f += 2)
          (O = H[f]), (S = H[f + 1]), (g = t(O, g, T, I, S)), (T = t(g, T, C, oe, S)), (C = t(T, C, k, K, S)), (A = t(C, k, A, Le, S)), (H[f] = A), (k = C), (C = T), (T = g), (g = O);
      for (; a < o; ) for (I = r.charCodeAt(s + (g = a)), A = ++a, f = 0; f < _; f += 2) (O = H[f]), (H[f] = A = t(O, g, A, I, H[f + 1])), (g = O);
      return A;
    };
  })();
});
...
var Ar = class {
  ...
  ms = (t, e) => {
    ...
    return { adapterName: e.adapterName, provider: e.provider, queryRaw: ie(t, e.queryRaw.bind(e)), executeRaw: ie(t, e.executeRaw.bind(e)), startTransaction: async (...n) => (await r(...n)).map((o) => ps(t, o)) };
  },
  ps = (t, e) => ({ adapterName: e.adapterName, provider: e.provider, options: e.options, queryRaw: ie(t, e.queryRaw.bind(e)), executeRaw: ie(t, e.executeRaw.bind(e)), commit: ie(t, e.commit.bind(e)), rollback: ie(t, e.rollback.bind(e)) });
function ie(t, e) {
  return async (...r) => {
    try {
      return Lt(await e(...r));
...
function Ue(t) {
  let e = Bs();
  return e || (t?.config.engineType === "library" ? "library" : t?.config.engineType === "binary" ? "binary" : t?.config.engineType === "client" ? "client" : Jn);
}
function Bs() {
...
function Xs({ functionName: t, location: e, message: r, isPanic: n, contextLines: i, callArguments: o }, s) {
  let a = [""],
    f = e ? " in" : ":";
  if (
    (n ? (a.push(s.red(`Oops, an unknown error occurred! This is ${s.bold("on us")}, you did nothing wrong.`)), a.push(s.red(`It occurred in the ${s.bold(`\`${t}\``)} invocation${f}`))) : a.push(s.red(`Invalid ${s.bold(`\`${t}\``)} invocation${f}`)),
...
function la(t, e) {
  ...
  n && (n.removeAllFields(), di(n, r)),
    e.addErrorMessage((o) => (i ? `The ${o.red("`select`")} statement for type ${o.bold(r.name)} must not be empty. ${mt(o)}` : `The ${o.red("`select`")} statement for type ${o.bold(r.name)} needs ${o.bold("at least one truthy value")}.`));
}
function ua(t, e) {
  let r = new ut();
...
function ca(t, e) {
  ...
  e.addErrorMessage((n) => {
    ...
    return r.parentKind !== "unknown" && i.push(`for ${n.bold(r.parentKind)} statement`), i.push(`on model ${n.bold(`\`${t.outputType.name}\``)}.`), i.push(mt(n)), i.join(" ");
  });
}
function ma(t, e) {
  let r = fi(t.selectionPath, e);
...
function fa(t, e) {
  let r;
  e.addErrorMessage((f) => (r?.value instanceof J && r.value.text === "null" ? `Argument \`${f.green(o)}\` must not be ${f.red("null")}.` : `Argument \`${f.green(o)}\` is missing.`));
  let n = e.arguments.getDeepSubSelectionValue(t.selectionPath)?.asObject();
  if (!n) return;
...
function fi(t, e) {
  ...
  return o && f
    ...
    : ((f = s?.getField(n)), s && f ? { parentKind: "include", field: f, parent: s, fieldName: n } : ((f = a?.getField(n)), a && f ? { parentKind: "omit", field: f, parent: a, fieldName: n } : { parentKind: "unknown", fieldName: n }));
}
function gi(t, e) {
...
var Wt = Symbol(),
  ...
  xe = class {
    constructor(e) {
      e === Wt ? Br.set(this, `Prisma.${this._getName()}`) : Br.set(this, `new Prisma.${this._getNamespace()}.${this._getName()}()`);
    }
    _getName() {
...
function wi(t) {
  ...
  if (t instanceof Uint8Array) return b.isBuffer(t) ? new J(`Buffer.alloc(${t.byteLength})`) : new J(`new Uint8Array(${t.byteLength})`);
...
function Ei(t, e, r) {
  return r ? qe(r, ({ needs: n, compute: i }, o) => ({ name: o, needs: n ? Object.keys(n).filter((s) => n[s]) : [], compute: Aa(e, o, i) })) : {};
}
function Aa(t, e, r) {
  let n = t?.[e]?.compute;
...
var Xt = class {
    ...
    clientExtensions = yt(() => (this.extension.client ? { ...this.previous?.getAllClientExtensions(), ...this.extension.client } : this.previous?.getAllClientExtensions()));
    batchCallbacks = yt(() => {
...
function tr({ modelName: t, action: e, args: r, runtimeDataModel: n, extensions: i = ze.empty(), callsite: o, clientMethod: s, errorFormat: a, clientVersion: f, previewFeatures: g, globalOmit: T }) {
  let C = new jr({ runtimeDataModel: n, modelName: t, action: e, rootArgs: r, callsite: o, extensions: i, selectionPath: [], argumentPath: [], originalMethod: s, errorFormat: a, clientVersion: f, previewFeatures: g, globalOmit: T });
    ...
    he(i) ||
      (i !== void 0
        ...
        : e.isPreviewFeatureOn("strictUndefinedChecks") &&
          e.throwValidationError({ kind: "InvalidArgumentValue", argumentPath: o.getArgumentPath(), selectionPath: e.getSelectionPath(), argument: { name: e.getArgumentName(), typeNames: [] }, underlyingError: Ai }));
  }
  return r;
}
function _a(t, e) {
...
function Qr(t, e) {
  t === void 0 && e.isPreviewFeatureOn("strictUndefinedChecks") && e.throwValidationError({ kind: "InvalidSelectionValue", selectionPath: e.getSelectionPath(), underlyingError: Ai });
}
var jr = class t {
  constructor(e) {
    this.params = e;
  ...
  throwValidationError(e) {
    Yt({ errors: [e], originalMethod: this.params.originalMethod, args: this.params.rootArgs ?? {}, callsite: this.params.callsite, errorFormat: this.params.errorFormat, clientVersion: this.params.clientVersion, globalOmit: this.params.globalOmit });
  }
  getSelectionPath() {
...
l();
function Oi(t) {
  if (!t._hasPreviewFlag("metrics")) throw new G("`metrics` preview feature must be enabled in order to access metrics API", { clientVersion: t._clientVersion });
}
var Ye = class {
  _client;
  constructor(e) {
...
function ar({ error: t, user_facing_error: e }, r, n) {
  return e.error_code ? new Y(Va(e, n), { code: e.error_code, clientVersion: r, meta: e.meta, batchRequestIdx: e.batch_request_idx }) : new j(t, { clientVersion: r, batchRequestIdx: e.batch_request_idx });
}
function Va(t, e) {
  let r = t.message;
  return (
      ...
      let o = i,
        s = (a) => (f) => {
          ...
          return t._createPrismaPromise(
            (T) => {
              let C = { args: f, dataPath: [], action: o, model: e, clientMethod: `${r}.${i}`, jsModelName: r, transaction: T, callsite: g };
...
function zi(t) {
  ...
  let e = Object.create(this._originalClient, { _extensions: { value: this._extensions.append(t) }, _appliedParent: { value: this, configurable: !0 }, $use: { value: void 0 }, $on: { value: void 0 } });
  return Pt(e);
}
u();
c();
...
function Zi({ result: t, modelName: e, args: r, extensions: n, runtimeDataModel: i, globalOmit: o }) {
  return n.isEmpty() || t == null || typeof t != "object" || !i.models[e]
    ...
    : ur({
        ...
        visitor: (a, f, g) => {
          let T = ge(f);
          return Yi({ result: a, modelName: T, select: g.select, omit: g.select ? void 0 : { ...o?.[T], ...g.omit }, extensions: n });
        },
      });
}
u();
...
var tn,
  fo = {
    async loadLibrary(t) {
      ...
      if (r === void 0) throw new M(`The \`adapter\` option for \`PrismaClient\` is required in this context (${Ce().prettyName})`, e);
...
var Tt = class {
  ...
  async transaction(e, r, n) {
    ...
    } else e === "commit" ? (o = await this.engine?.commitTransaction(n.id, i)) : e === "rollback" && (o = await this.engine?.rollbackTransaction(n.id, i));
...
${a.backtrace}`,
  ...
  async requestBatch(e, { transaction: r, traceparent: n }) {
    ye("requestBatch");
    let i = sr(e, r);
    await this.start(), (this.lastQuery = JSON.stringify(i)), (this.executingQueryPromise = this.engine.query(this.lastQuery, JSON.stringify({ traceparent: n }), po(r)));
    let o = await this.executingQueryPromise,
      s = this.parseEngineResponse(o);
    if (s.errors) throw s.errors.length === 1 ? this.buildQueryError(s.errors[0]) : new j(JSON.stringify(s.errors), { clientVersion: this.config.clientVersion });
    let { batchResult: a, errors: f } = s;
    if (Array.isArray(a)) return a.map((g) => (g.errors && g.errors.length > 0 ? this.loggerRustPanic ?? this.buildQueryError(g.errors[0]) : { data: g }));
...
function go({ copyEngine: t = !0 }, e) {
  ...
  if ((o && s) || (s && !1)) {
    ...
    throw (
      (t
        ? r?.startsWith("prisma://")
          ? (T = ["Prisma Client was configured to use the `adapter` option but the URL was a `prisma://` URL.", "Please either use the `prisma://` URL or remove the `adapter` from the Prisma Client constructor."])
          : (T = ["Prisma Client was configured to use both the `adapter` and Accelerate, please chose one."])
        : (T = ["Prisma Client was configured to use the `adapter` option but `prisma generate` was run with `--no-engine`.", "Please run `prisma generate` without `--no-engine` to be able to use Prisma Client with the adapter."]),
      new G(
        T.join(`
`),
...
var kl = ee("prisma:client:request_handler"),
  yr = class {
      ...
      (this.logEmitter = r),
        ...
        (this.dataloader = new gr({
          batchLoader: oo(async ({ requests: n, customDataProxyFetch: i }) => {
            ...
            return (await this.client._engine.requestBatch(a, { traceparent: f, transaction: Ol(o), containsWrite: g, customDataProxyFetch: i })).map((C, k) => {
          ...
          singleLoader: async (n) => {
            let i = n.transaction?.kind === "itx" ? Io(n.transaction) : void 0,
              o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: un(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch });
    ...
    handleRequestError({ error: e, clientMethod: r, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
      ...
      let f = e.message;
      if ((n && (f = Vt({ callsite: n, originalMethod: r, isPanic: e.isPanic, showColors: this.client._errorFormat === "pretty", message: f })), (f = this.sanitizeMessage(f)), e.code)) {
...
var Do = ["datasources", "datasourceUrl", "errorFormat", "adapter", "log", "transactionOptions", "omit", "__internal"],
  ...
  _l = {
    datasources: (t, { datasourceNames: e }) => {
      if (t) {
        if (typeof t != "object" || Array.isArray(t)) throw new L(`Invalid value ${JSON.stringify(t)} for "datasources" provided to PrismaClient constructor`);
        for (let [r, n] of Object.entries(t)) {
          if (!e.includes(r)) {
...
It should have this form: { url: "CONNECTION_STRING" }`);
    ...
    adapter: (t, e) => {
      if (!t && Ue(e.generator) === "client") throw new L('Using engine type "client" requires a driver adapter to be provided to PrismaClient constructor.');
      if (t === null) return;
      if (t === void 0) throw new L('"adapter" property must not be undefined, use null to conditionally disable driver adapters.');
      if (!pr(e).includes("driverAdapters")) throw new L('"adapter" property can only be provided to PrismaClient constructor when "driverAdapters" preview feature is enabled.');
      if (Ue(e.generator) === "binary") throw new L('Cannot use a driver adapter with the "binary" Query Engine. Please use the "library" Query Engine.');
    },
    datasourceUrl: (t) => {
...
Expected string or undefined.`);
    ...
    errorFormat: (t) => {
      if (t) {
        if (typeof t != "string") throw new L(`Invalid value ${JSON.stringify(t)} for "errorFormat" provided to PrismaClient constructor.`);
        if (!Fo.includes(t)) {
          let e = tt(t, Fo);
    ...
    transactionOptions: (t) => {
      if (!t) return;
      let e = t.maxWait;
      if (e != null && e <= 0) throw new L(`Invalid value ${e} for maxWait in "transactionOptions" provided to PrismaClient constructor. maxWait needs to be greater than 0`);
      let r = t.timeout;
...
function Bo(t, e) {
  ...
  if (t.datasourceUrl && t.datasources) throw new L('Can not use "datasourceUrl" and "datasources" options at the same time. Pick one of them');
}
function tt(t, e) {
...
function Qo(t) {
  class e {
    ...
    constructor(n) {
      ...
      let o = { rootEnvPath: t.relativeEnvPaths.rootEnvPath && ot.resolve(t.dirname, t.relativeEnvPaths.rootEnvPath), schemaEnvPath: t.relativeEnvPaths.schemaEnvPath && ot.resolve(t.dirname, t.relativeEnvPaths.schemaEnvPath) },
        s;
      if (n?.adapter) {
        s = Sr(n.adapter);
      ...
      try {
        ...
        let k = g.engine || {};
        if (
          (f.errorFormat ? (this._errorFormat = f.errorFormat) : h.env.NODE_ENV === "production" ? (this._errorFormat = "minimal") : h.env.NO_COLOR ? (this._errorFormat = "colorless") : (this._errorFormat = "colorless"),
    ...
    $executeRawInternal(n, i, o, s) {
      ...
      return this._request({ action: "executeRaw", args: o, transaction: n, clientMethod: i, argsMapper: on({ clientMethod: i, activeProvider: a }), callsite: Te(this._errorFormat), dataPath: [], middlewareArgsMapper: s });
    }
    $executeRaw(n, ...i) {
    ...
    $runCommandRaw(n) {
      if (t.activeProvider !== "mongodb") throw new G(`The ${t.activeProvider} provider does not support $runCommandRaw. Use the mongodb provider.`, { clientVersion: this._clientVersion });
      return this._createPrismaPromise((i) => this._request({ args: n, clientMethod: "$runCommandRaw", dataPath: [], action: "runCommandRaw", argsMapper: ho, callsite: Te(this._errorFormat), transaction: i }));
    }
    async $queryRawInternal(n, i, o, s) {
      let a = this._activeProvider;
      return this._request({ action: "queryRaw", args: o, transaction: n, clientMethod: i, argsMapper: on({ clientMethod: i, activeProvider: a }), callsite: Te(this._errorFormat), dataPath: [], middlewareArgsMapper: s });
    }
    $queryRaw(n, ...i) {
      return this._createPrismaPromise((o) => {
    ...
    $queryRawTyped(n) {
      return this._createPrismaPromise((i) => {
        if (!this._hasPreviewFlag("typedSql")) throw new G("`typedSql` preview feature must be enabled in order to access $queryRawTyped API", { clientVersion: this._clientVersion });
    ...
    _createItxClient(n) {
      return ae(Pt(ae(Hi(this), [W("_appliedParent", () => this._appliedParent._createItxClient(n)), W("_createPrismaPromise", () => sn(n)), W(ql, () => n.id)])), [Xe(eo)]);
    }
    $transaction(n, i) {
      let o;
      typeof n == "function"
    ...
    _request(n) {
      ...
      let i = n.middlewareArgsMapper ?? Ul,
        ...
        f = async (g) => {
          ...
          return O.model ? Zi({ result: S, modelName: O.model, args: O.args, extensions: this._extensions, runtimeDataModel: this._runtimeDataModel, globalOmit: this._globalOmit }) : S;
        };
