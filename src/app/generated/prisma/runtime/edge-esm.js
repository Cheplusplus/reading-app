...
var Le = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  wa = (e, t, r, n) => {
    if ((t && typeof t == "object") || typeof t == "function") for (let i of fa(t)) !ha.call(e, i) && i !== r && ar(e, i, { get: () => t[i], enumerable: !(n = da(t, i)) || n.enumerable });
    return e;
  };
...
var Ci = Le((Ye) => {
    ...
    Ea = pi((e) => {
      ...
      function g(R) {
        ...
        return (
          ...
          U === 1 && ((S = (r[R.charCodeAt(Q)] << 10) | (r[R.charCodeAt(Q + 1)] << 4) | (r[R.charCodeAt(Q + 2)] >> 2)), (D[L++] = (S >> 8) & 255), (D[L++] = S & 255)),
          D
        );
      }
      function h(R) {
            ...
            r = Math.abs(r),
              isNaN(r) || r === 1 / 0
                ...
                : ((a = Math.floor(Math.log(r) / Math.LN2)),
                  ...
                  r * f >= 2 && (a++, (f /= 2)),
                  a + T >= h ? ((l = 0), (a = h)) : a + T >= 1 ? ((l = (r * f - 1) * Math.pow(2, o)), (a = a + T)) : ((l = r * Math.pow(2, T - 1) * Math.pow(2, o)), (a = 0)));
            o >= 8;
  ...
  function mi(e, t, r) {
    ...
    if (fe(e, ArrayBuffer) || (e && fe(e.buffer, ArrayBuffer)) || (typeof SharedArrayBuffer < "u" && (fe(e, SharedArrayBuffer) || (e && fe(e.buffer, SharedArrayBuffer))))) return fi(e, t, r);
  ...
  C.compare = function (e, t) {
    if ((fe(e, Uint8Array) && (e = C.from(e, e.offset, e.byteLength)), fe(t, Uint8Array) && (t = C.from(t, t.offset, t.byteLength)), !C.isBuffer(e) || !C.isBuffer(t)))
  ...
  function xi(e, t, r, n, i) {
    return (t = +t), (r = r >>> 0), i || bi(e, t, r, 4, 34028234663852886e22, -34028234663852886e22), Ke.write(e, t, r, n, 23, 4), r + 4;
  }
  ...
  function Pi(e, t, r, n, i) {
    return (t = +t), (r = r >>> 0), i || bi(e, t, r, 8, 17976931348623157e292, -17976931348623157e292), Ke.write(e, t, r, n, 52, 8), r + 8;
  }
  ...
  cn(
    ...
    function (e, t, r) {
      let n = `The value of "${e}" is out of range.`,
        i = r;
      return (
        Number.isInteger(r) && Math.abs(r) > 2 ** 32 ? (i = ci(String(r))) : typeof r == "bigint" && ((i = String(r)), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (i = ci(i)), (i += "n")),
    ...
    return function (t, r) {
      ...
      for (var B = L.length - 1; a < o - 3; )
        for (M = r.charCodeAt(s + (f = a)), N = r.charCodeAt(s + (g = a + 1)), U = r.charCodeAt(s + (h = a + 2)), D = r.charCodeAt(s + (T = a + 3)), k = a += 4, l = 0; l < B; l += 2)
          (R = L[l]), (S = L[l + 1]), (f = e(R, f, g, M, S)), (g = e(f, g, h, N, S)), (h = e(g, h, T, U, S)), (k = e(h, T, k, D, S)), (L[l] = k), (T = h), (h = g), (g = f), (f = R);
...
var dn = class {
  ...
  Qa = (e, t) => {
    ...
    return { adapterName: t.adapterName, provider: t.provider, queryRaw: ce(e, t.queryRaw.bind(t)), executeRaw: ce(e, t.executeRaw.bind(t)), startTransaction: async (...n) => (await r(...n)).map((o) => Wa(e, o)) };
  },
  Wa = (e, t) => ({ adapterName: t.adapterName, provider: t.provider, options: t.options, queryRaw: ce(e, t.queryRaw.bind(t)), executeRaw: ce(e, t.executeRaw.bind(t)), commit: ce(e, t.commit.bind(t)), rollback: ce(e, t.rollback.bind(t)) });
function ce(e, t) {
  return async (...r) => {
    try {
      return cr(await t(...r));
...
function Xe(e) {
  let t = xl();
  return t || (e?.config.engineType === "library" ? "library" : e?.config.engineType === "binary" ? "binary" : e?.config.engineType === "client" ? "client" : Xi);
}
function xl() {
...
var se = class extends Error {
  constructor(r, { code: n, clientVersion: i, meta: o, batchRequestIdx: s }) {
    ...
    (this.name = "PrismaClientKnownRequestError"), (this.code = n), (this.clientVersion = i), (this.meta = o), Object.defineProperty(this, "batchRequestIdx", { value: s, enumerable: !1, writable: !0 });
  }
  get [Symbol.toStringTag]() {
...
var ae = class extends Error {
  constructor(r, { clientVersion: n, batchRequestIdx: i }) {
    ...
    w(this, "clientVersion");
    w(this, "batchRequestIdx");
    (this.name = "PrismaClientUnknownRequestError"), (this.clientVersion = n), Object.defineProperty(this, "batchRequestIdx", { value: i, writable: !0, enumerable: !1 });
  }
  get [Symbol.toStringTag]() {
...
A.cosine = A.cos = function () {
  ...
  return r.d
    ? r.d[0]
      ? ((e = n.precision), (t = n.rounding), (n.precision = e + Math.max(r.e, r.sd()) + O), (n.rounding = 1), (r = Dl(n, To(n, r))), (n.precision = e), (n.rounding = t), I(ve == 2 || ve == 3 ? r.neg() : r, e, t, !0))
      : new n(1)
    : new n(NaN);
};
...
A.hyperbolicSine = A.sinh = function () {
  ...
  if (((t = o.precision), (r = o.rounding), (o.precision = t + Math.max(i.e, i.sd()) + 4), (o.rounding = 1), (n = i.d.length), n < 3)) i = rt(o, 2, i, i, !0);
  else {
...
A.inverseHyperbolicCosine = A.acosh = function () {
  ...
  return r.lte(1)
    ? new n(r.eq(1) ? 0 : NaN)
    : r.isFinite()
    ? ((e = n.precision), (t = n.rounding), (n.precision = e + Math.max(Math.abs(r.e), r.sd()) + 4), (n.rounding = 1), (_ = !1), (r = r.times(r).minus(1).sqrt().plus(r)), (_ = !0), (n.precision = e), (n.rounding = t), r.ln())
    : new n(r);
};
A.inverseHyperbolicSine = A.asinh = function () {
  ...
  return !r.isFinite() || r.isZero()
    ? new n(r)
    : ((e = n.precision), (t = n.rounding), (n.precision = e + 2 * Math.max(Math.abs(r.e), r.sd()) + 6), (n.rounding = 1), (_ = !1), (r = r.times(r).plus(1).sqrt().plus(r)), (_ = !0), (n.precision = e), (n.rounding = t), r.ln());
};
  ...
  return i.isFinite()
    ? i.e >= 0
      ...
      : ((e = o.precision),
        (t = o.rounding),
        (n = i.sd()),
        Math.max(n, e) < 2 * -i.e - 1 ? I(new o(i), e, t, !0) : ((o.precision = r = n - i.e), (i = V(i.plus(1), new o(1).minus(i), r + e, 1)), (o.precision = e + 4), (o.rounding = 1), (i = i.ln()), (o.precision = e), (o.rounding = t), i.times(0.5)))
    : new o(NaN);
};
A.inverseSine = A.asin = function () {
  ...
  return i.isZero()
    ...
    : ((t = i.abs().cmp(1)),
      (r = o.precision),
      (n = o.rounding),
      t !== -1 ? (t === 0 ? ((e = ge(o, r + 4, n).times(0.5)), (e.s = i.s), e) : new o(NaN)) : ((o.precision = r + 6), (o.rounding = 1), (i = i.div(new o(1).minus(i.times(i)).sqrt().plus(1)).atan()), (o.precision = r), (o.rounding = n), i.times(2)));
};
...
A.sine = A.sin = function () {
  ...
  return r.isFinite()
    ? r.isZero()
      ? new n(r)
      : ((e = n.precision), (t = n.rounding), (n.precision = e + Math.max(r.e, r.sd()) + O), (n.rounding = 1), (r = Nl(n, To(n, r))), (n.precision = e), (n.rounding = t), I(ve > 2 ? r.neg() : r, e, t, !0))
    : new n(NaN);
};
A.squareRoot = A.sqrt = function () {
  ...
  for (
    _ = !1,
      f = Math.sqrt(+s),
      f == 0 || f == 1 / 0
        ? ((t = Y(a)), (t.length + l) % 2 == 0 && (t += "0"), (f = Math.sqrt(t)), (l = X((l + 1) / 2) - (l < 0 || l % 2)), f == 1 / 0 ? (t = "5e" + l) : ((t = f.toExponential()), (t = t.slice(0, t.indexOf("e") + 1) + l)), (n = new g(t)))
        : (n = new g(f.toString())),
      r = (l = g.precision) + 3;
    ;
...
A.times = A.mul = function (e) {
  ...
  for (r = X(g.e / O) + X(e.e / O), l = T.length, f = k.length, l < f && ((o = T), (T = k), (k = o), (s = l), (l = f), (f = s)), o = [], s = l + f, n = s; n--; ) o.push(0);
  for (n = f; --n >= 0; ) {
...
A.toExponential = function (e, t) {
  var r,
    n = this,
    i = n.constructor;
  return e === void 0 ? (r = he(n, !0)) : (ie(e, 0, Me), t === void 0 ? (t = i.rounding) : ie(t, 0, 8), (n = I(new i(n), e + 1, t)), (r = he(n, !0, e + 1))), n.isNeg() && !n.isZero() ? "-" + r : r;
};
A.toFixed = function (e, t) {
  var r,
    ...
    i = this,
    o = i.constructor;
  return e === void 0 ? (r = he(i)) : (ie(e, 0, Me), t === void 0 ? (t = o.rounding) : ie(t, 0, 8), (n = I(new o(i), e + i.e + 1, t)), (r = he(n, !1, e + n.e + 1))), i.isNeg() && !i.isZero() ? "-" + r : r;
};
A.toFraction = function (e) {
  var t,
    ...
    S = k.constructor;
  if (!R) return new S(k);
  if (((f = r = new S(1)), (n = l = new S(0)), (t = new S(n)), (o = t.e = bo(R) - k.e - 1), (s = o % O), (t.d[0] = H(10, s < 0 ? O + s : s)), e == null)) e = o > 0 ? t : f;
  else {
  ...
  return (i = V(e.minus(r), n, 0, 1, 1)), (l = l.plus(i.times(f))), (r = r.plus(i.times(n))), (l.s = f.s = k.s), (T = V(f, n, o, 1).minus(k).abs().cmp(V(l, r, o, 1).minus(k).abs()) < 1 ? [f, n] : [l, r]), (S.precision = g), (_ = !0), T;
};
...
A.toPower = A.pow = function (e) {
  ...
  if (((t = X(e.e / O)), t >= e.d.length - 1 && (r = f < 0 ? -f : f) <= Il)) return (i = xo(l, a, r, n)), e.s < 0 ? new l(1).div(i) : I(i, n, o);
  if (((s = a.s), s < 0)) {
  ...
  return (
    ...
    t > l.maxE + 1 || t < l.minE - 1
      ...
      : ((_ = !1),
        ...
        i.d && ((i = I(i, n + 5, 1)), St(i.d, n, o) && ((t = n + 10), (i = I(An(e.times(Oe(a, t + r)), t), t + 5, 1)), +Y(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = I(i, n + 1, 0)))),
        (i.s = s),
        (_ = !0),
        (l.rounding = o),
        I(i, n, o))
...
A.toPrecision = function (e, t) {
  var r,
    ...
    i = n.constructor;
  return (
    e === void 0 ? (r = he(n, n.e <= i.toExpNeg || n.e >= i.toExpPos)) : (ie(e, 1, Me), t === void 0 ? (t = i.rounding) : ie(t, 0, 8), (n = I(new i(n), e, t)), (r = he(n, e <= n.e || n.e <= i.toExpNeg, e))), n.isNeg() && !n.isZero() ? "-" + r : r
  );
};
A.toSignificantDigits = A.toSD = function (e, t) {
  var r = this,
    n = r.constructor;
  return e === void 0 ? ((e = n.precision), (t = n.rounding)) : (ie(e, 1, Me), t === void 0 ? (t = n.rounding) : ie(t, 0, 8)), I(new n(r), e, t);
};
A.toString = function () {
  var e = this,
    t = e.constructor,
  ...
  return (
    ...
    n == null
      ? t < 3
        ...
        : (s = (((r < 4 && a + 1 == o) || (r > 3 && a + 1 == o / 2)) && ((e[i + 1] / o / 100) | 0) == H(10, t - 2) - 1) || ((a == o / 2 || a == 0) && ((e[i + 1] / o / 100) | 0) == 0))
      : t < 4
      ? (t == 0 ? (a = (a / 1e3) | 0) : t == 1 ? (a = (a / 100) | 0) : t == 2 && (a = (a / 10) | 0), (s = ((n || r < 4) && a == 9999) || (!n && r > 3 && a == 4999)))
      : (s = (((n || r < 4) && a + 1 == o) || (!n && r > 3 && a + 1 == o / 2)) && ((e[i + 1] / o / 1e3) | 0) == H(10, t - 3) - 1),
    s
  );
}
function wr(e, t, r) {
...
function Dl(e, t) {
  ...
  (n = t.d.length), n < 32 ? ((r = Math.ceil(n / 3)), (i = (1 / Cr(4, r)).toString())) : ((r = 16), (i = "2.3283064365386962890625e-10")), (e.precision += r), (t = rt(e, 1, t.times(i), new e(1)));
  for (var o = r; o--; ) {
    var s = t.times(t);
...
var V = (function () {
  ...
  return function (n, i, o, s, a, l) {
    var f,
      ...
      Z = n.d,
      j = i.d;
    if (!Z || !Z[0] || !j || !j[0]) return new sr(!n.s || !i.s || (Z ? j && Z[0] == j[0] : !j) ? NaN : (Z && Z[0] == 0) || !j ? rn * 0 : rn / 0);
    for (l ? ((k = 1), (g = n.e - i.e)) : ((l = me), (k = O), (g = X(n.e / k) - X(i.e / k))), pe = j.length, Pt = Z.length, N = new sr(rn), U = N.d = [], h = 0; j[h] == (Z[h] || 0); h++);
    if ((j[h] > (Z[h] || 0) && g--, o == null ? ((Q = o = sr.precision), (s = sr.rounding)) : a ? (Q = o + (n.e - i.e) + 1) : (Q = o), Q < 0)) U.push(1), (R = !0);
    else {
      if (((Q = (Q / k + 2) | 0), (h = 0), pe == 1)) {
        for (T = 0, j = j[0], Q++; (h < Pt || T) && Q--; h++) (en = T * l + (Z[h] || 0)), (U[h] = (en / j) | 0), (T = en % j | 0);
        R = T || h < Pt;
      } else {
        for (T = (l / (j[0] + 1)) | 0, T > 1 && ((j = e(j, T, l)), (Z = e(Z, T, l)), (pe = j.length), (Pt = Z.length)), ir = pe, D = Z.slice(0, pe), L = D.length; L < pe; ) D[L++] = 0;
          ...
          (T = 0),
            ...
            f < 0
              ? ((B = D[0]),
                pe != L && (B = B * l + (D[1] || 0)),
                (T = (B / tn) | 0),
                T > 1 ? (T >= l && (T = l - 1), (S = e(j, T, l)), (M = S.length), (L = D.length), (f = t(S, D, M, L)), f == 1 && (T--, r(S, pe < M ? or : j, M, l))) : (T == 0 && (f = T = 1), (S = j.slice())),
                (M = S.length),
                M < L && S.unshift(0),
                r(D, S, L, l),
...
function I(e, t, r, n) {
  ...
  e: if (t != null) {
    ...
    if (
      ...
      (f = r < 4 ? (l || n) && (r == 0 || r == (e.s < 0 ? 3 : 2)) : l > 5 || (l == 5 && (r == 4 || n || (r == 6 && (o > 0 ? (s > 0 ? g / H(10, i - s) : 0) : h[T - 1]) % 10 & 1) || r == (e.s < 0 ? 8 : 7)))),
      t < 1 || !h[0])
    )
...
function Oe(e, t) {
  ...
  if ((t == null ? ((_ = !1), (g = D)) : (g = t), (N.precision = g += R), (r = Y(M)), (n = r.charAt(0)), Math.abs((o = S.e)) < 15e14)) {
    for (; (n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3); ) (S = S.times(e)), (r = Y(S.d)), (n = r.charAt(0)), k++;
    (o = S.e), n > 1 ? ((S = new N("0." + r)), o++) : (S = new N(n + "." + r.slice(1)));
  } else return (f = Pr(N, g + 2, D).times(o + "")), (S = Oe(new N(n + "." + r.slice(1)), g - R).plus(f)), (N.precision = D), t == null ? I(S, D, U, (_ = !0)) : S;
  for (h = S, l = s = S = V(S.minus(1), S.plus(1), g, 1), T = I(S.times(S), g, 1), i = 3; ; ) {
    if (((s = I(s.times(T), g, 1)), (f = l.plus(V(s, new N(i), g, 1))), Y(f.d).slice(0, g) === Y(l.d).slice(0, g)))
      if (((l = l.times(2)), o !== 0 && (l = l.plus(Pr(N, g + 2, D).times(o + ""))), (l = V(l, new N(k), g, 1)), t == null))
        if (St(l.d, g - R, U, a)) (N.precision = g += R), (f = s = S = V(h.minus(1), h.plus(1), g, 1)), (T = I(S.times(S), g, 1)), (i = a = 1);
...
function Ml(e, t) {
  ...
  for (
    ...
    f.pop();
  return o < 0 ? new n(e.s * 0) : ((e.e = Tr(f, g)), (e.d = f), (_ = !1), s && (e = V(e, i, a * 4)), l && (e = e.times(Math.abs(l) < 54 ? H(2, l) : Ue.pow(2, l))), (_ = !0), e);
}
function Nl(e, t) {
  var r,
    n = t.d.length;
...
function Rn(e, t, r, n) {
  var i,
    ...
    k = e.constructor,
    R = r !== void 0;
  if ((R ? (ie(r, 1, Me), n === void 0 ? (n = k.rounding) : ie(n, 0, 8)) : ((r = k.precision), (n = k.rounding)), !e.isFinite())) g = vo(e);
  else {
    for (
      g = he(e),
        s = g.indexOf("."),
    ...
    if (!h[0]) g = R ? "0p+0" : "0";
      ...
      if (
        ...
        (a = i / 2),
        (f = f || h[r + 1] !== void 0),
        (f = n < 4 ? (s !== void 0 || f) && (n === 0 || n === (e.s < 0 ? 3 : 2)) : s > a || (s === a && (n === 4 || f || (n === 6 && h[r - 1] & 1) || n === (e.s < 0 ? 8 : 7)))),
        (h.length = r),
        f)
      )
...
function jl(e, t) {
  ...
  return (
    !e.s || !t.s
      ...
      : t.s < 0
      ? ((this.precision = o), (this.rounding = 1), (r = this.atan(V(e, t, o, 1))), (t = ge(this, o, 1)), (this.precision = n), (this.rounding = i), (r = e.s < 0 ? r.minus(t) : r.plus(t)))
...
function Wl(e) {
  ...
  var t,
    ...
    n,
    i = e.defaults === !0,
    o = ["precision", 1, Me, "rounding", 0, 8, "toExpNeg", -tt, 0, "toExpPos", 0, tt, "maxE", 0, tt, "minE", -tt, 0, "modulo", 0, 9];
...
function Co(e) {
  ...
  function i(o) {
    ...
    if (l === "string") return (a = o.charCodeAt(0)) === 45 ? ((o = o.slice(1)), (f.s = -1)) : (a === 43 && (o = o.slice(1)), (f.s = 1)), Eo.test(o) ? Er(f, o) : Ml(f, o);
...
var ut = class e extends Ne {
  ...
  getDeepField(r) {
    ...
    for (let a of i) {
      let l;
      if ((s.value instanceof e ? (l = s.value.getField(a)) : s.value instanceof lt && (l = s.value.getField(Number(a))), !l)) return;
      s = l;
    }
    return s;
  }
...
function Fu(e, t) {
  ...
  n && (n.removeAllFields(), _o(n, r)),
    t.addErrorMessage((o) => (i ? `The ${o.red("`select`")} statement for type ${o.bold(r.name)} must not be empty. ${Dt(o)}` : `The ${o.red("`select`")} statement for type ${o.bold(r.name)} needs ${o.bold("at least one truthy value")}.`));
}
function Lu(e, t) {
  let r = new It();
...
var Mr = Symbol(),
  ...
  Ce = class {
    constructor(t) {
      t === Mr ? kn.set(this, `Prisma.${this._getName()}`) : kn.set(this, `new Prisma.${this._getNamespace()}.${this._getName()}()`);
    }
    _getName() {
...
function jo(e, t, r) {
  let n = Ee(r);
  return !t.result || !(t.result.$allModels || t.result[n]) ? e : ec({ ...e, ...Vo(t.name, e, t.result.$allModels), ...Vo(t.name, e, t.result[n]) });
}
function ec(e) {
  let t = new we(),
...
function Vo(e, t, r) {
  return r ? et(r, ({ needs: n, compute: i }, o) => ({ name: o, needs: n ? Object.keys(n).filter((s) => n[s]) : [], compute: tc(t, o, i) })) : {};
}
function tc(e, t, r) {
  let n = e?.[t]?.compute;
...
var Lr = class {
    constructor(t, r) {
      ...
      w(
        this,
        "clientExtensions",
        Bt(() => (this.extension.client ? { ...this.previous?.getAllClientExtensions(), ...this.extension.client } : this.previous?.getAllClientExtensions()))
      );
      w(
        this,
        "batchCallbacks",
...
function _n({ modelName: e, action: t, args: r, runtimeDataModel: n, extensions: i = mt.empty(), callsite: o, clientMethod: s, errorFormat: a, clientVersion: l, previewFeatures: f, globalOmit: g }) {
  let h = new Nn({ runtimeDataModel: n, modelName: e, action: t, rootArgs: r, callsite: o, extensions: i, selectionPath: [], argumentPath: [], originalMethod: s, errorFormat: a, clientVersion: l, previewFeatures: f, globalOmit: g });
    ...
    be(i) ||
      (i !== void 0
        ...
        : t.isPreviewFeatureOn("strictUndefinedChecks") &&
          t.throwValidationError({ kind: "InvalidArgumentValue", argumentPath: o.getArgumentPath(), selectionPath: t.getSelectionPath(), argument: { name: t.getArgumentName(), typeNames: [] }, underlyingError: Ho }));
  }
  return r;
}
function uc(e, t) {
...
function Fn(e, t) {
  e === void 0 && t.isPreviewFeatureOn("strictUndefinedChecks") && t.throwValidationError({ kind: "InvalidSelectionValue", selectionPath: t.getSelectionPath(), underlyingError: Ho });
}
var Nn = class e {
  constructor(t) {
    this.params = t;
...
function Gr({ error: e, user_facing_error: t }, r, n) {
  return t.error_code ? new se(xc(t, n), { code: t.error_code, clientVersion: r, meta: t.meta, batchRequestIdx: t.batch_request_idx }) : new ae(e, { clientVersion: r, batchRequestIdx: t.batch_request_idx });
}
function xc(e, t) {
  let r = e.message;
  return (
...
function ft(e = {}) {
  let t = vc(e);
  return Object.entries(t).reduce((n, [i, o]) => (is[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n), { select: {} });
}
function vc(e = {}) {
...
function Qr({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
  ...
  let o = e(t, i, r) ?? t;
  return r.include && hs({ includeOrSelect: r.include, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }), r.select && hs({ includeOrSelect: r.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }), o;
}
...
function ys({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: i, globalOmit: o }) {
  return n.isEmpty() || e == null || typeof e != "object" || !i.models[t]
    ...
    : Qr({
        ...
        visitor: (a, l, f) => {
          let g = Ee(l);
          return gs({ result: a, modelName: g, select: f.select, omit: f.select ? void 0 : { ...o?.[g], ...f.omit }, extensions: n });
        },
      });
}
d();
...
function Os(e) {
  ...
  return (
    i == 1 ? ((g = t[o]), (s = (g & 252) >> 2), (a = (g & 3) << 4), (r += Ae[s] + Ae[a] + "==")) : i == 2 && ((g = (t[o] << 8) | t[o + 1]), (s = (g & 64512) >> 10), (a = (g & 1008) >> 4), (l = (g & 15) << 2), (r += Ae[s] + Ae[a] + Ae[l] + "=")), r
  );
}
d();
u();
  ...
  Et = class {
    ...
    async start() {
      this.startPromise !== void 0 && (await this.startPromise),
        (this.startPromise = (async () => {
          ...
          (this.host = t),
            (this.headerBuilder = new Xn({ apiKey: r, tracingHelper: this.tracingHelper, logLevel: this.config.logLevel, logQueries: this.config.logQueries, engineHash: this.engineHash })),
    ...
    extractHostAndApiKey() {
      let t = { clientVersion: this.clientVersion },
        ...
        n = gt({ inlineDatasources: this.inlineDatasources, overrideDatasources: this.config.overrideDatasources, clientVersion: this.clientVersion, env: this.env }),
        i;
      try {
        i = new URL(n);
      } catch {
      ...
      if (o !== "prisma:" && o !== fr) throw new Ve(`Error validating datasource \`${r}\`: the URL must start with the protocol \`prisma://\``, t);
      let l = a.get("api_key");
    ...
    convertProtocolErrorsToClientError(t) {
      return t.length === 1 ? Gr(t[0], this.config.clientVersion, this.config.activeProvider) : new ae(JSON.stringify(t), { clientVersion: this.config.clientVersion });
    }
...
function Ls({ copyEngine: e = !0 }, t) {
  ...
  if ((o && s) || s) {
    let g;
    throw (
      ((g = ["Prisma Client was configured to use the `adapter` option but it was imported via its `/edge` endpoint.", "Please either remove the `/edge` endpoint or remove the `adapter` from the Prisma Client constructor."]),
      new te(
        g.join(`
`),
...
var pp = ee("prisma:client:request_handler"),
  Xr = class {
      ...
      (this.logEmitter = r),
        ...
        (this.dataloader = new Zr({
          batchLoader: vs(async ({ requests: n, customDataProxyFetch: i }) => {
            ...
            return (await this.client._engine.requestBatch(a, { traceparent: l, transaction: mp(o), containsWrite: f, customDataProxyFetch: i })).map((h, T) => {
          ...
          singleLoader: async (n) => {
            let i = n.transaction?.kind === "itx" ? Xs(n.transaction) : void 0,
              o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: oi(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch });
    ...
    handleRequestError({ error: t, clientMethod: r, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
      ...
      let l = t.message;
      if ((n && (l = Rr({ callsite: n, originalMethod: r, isPanic: t.isPanic, showColors: this.client._errorFormat === "pretty", message: l })), (l = this.sanitizeMessage(l)), t.code)) {
...
It should have this form: { url: "CONNECTION_STRING" }`);
    ...
    adapter: (e, t) => {
      ...
      if (!Kr(t).includes("driverAdapters")) throw new $('"adapter" property can only be provided to PrismaClient constructor when "driverAdapters" preview feature is enabled.');
...
function vp(e) {
  class t {
    constructor(n) {
      ...
      (this._extensions = mt.empty()), (this._previewFeatures = Kr(e)), (this._clientVersion = e.clientVersion ?? ra), (this._activeProvider = e.activeProvider), (this._globalOmit = n?.omit), (this._tracingHelper = Hs());
      let o = { rootEnvPath: e.relativeEnvPaths.rootEnvPath && Ct.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath), schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && Ct.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath) },
        s;
      if (n?.adapter) {
        s = fn(n.adapter);
    ...
    $runCommandRaw(n) {
      ...
      return this._createPrismaPromise((i) => this._request({ args: n, clientMethod: "$runCommandRaw", dataPath: [], action: "runCommandRaw", argsMapper: Bs, callsite: _e(this._errorFormat), transaction: i }));
    }
    ...
    _createItxClient(n) {
      return de(Gt(de(ds(this), [re("_appliedParent", () => this._appliedParent._createItxClient(n)), re("_createPrismaPromise", () => ri(n)), re(xp, () => n.id)])), [dt(ws)]);
    }
    $transaction(n, i) {
      let o;
      typeof n == "function"
    ...
    _request(n) {
      ...
      let i = n.middlewareArgsMapper ?? bp,
        ...
        l = async (f) => {
          ...
          return R.model ? ys({ result: S, modelName: R.model, args: R.args, extensions: this._extensions, runtimeDataModel: this._runtimeDataModel, globalOmit: this._globalOmit }) : S;
        };
